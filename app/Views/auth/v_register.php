...
<div class="register-box">
  <div class="register-logo">
    <a href="<?= base_url('auth/register')?>"><b>Gudang&nbsp;Web</b></a>
  </div>
...
echo '</div>';
    ...
    <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="notelpon_user" class="form-control" placeholder="Masukkan No Telepon Pengguna">
    ...
    <option value="2">Pemilik</option>
      ...
      <div class="form-group has-feedback">
        <input type="password" name="repassword"  class="form-control" placeholder="Masukkan Ulang Password">
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      </div>

      <div class="row">
        <div class="col-xs-8">
        <a href="<?= base_url('auth/login')?>" class="text-center">Silahkan Kembail Ke Login !!!</a>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
