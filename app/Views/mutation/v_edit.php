...
<div class="alert alert-danger" role="alert">
    ...
    <form onsubmit="return checkStockMutation()" action="<?= base_url('mutation/update/' . $data_mutation['id_mutation']); ?>" method="post">
<div class="form-group">
    ...
    <select name="cabang_asal" id="cabang_asal" class="form-control" onchange="updateAvailableStock()">
        ...
        <option value="<?= $value['id_cabang']?>" <?= $data_mutation['cabang_asal'] == $value['id_cabang'] ?'selected' : '' ?>><?= $value['nama_cabang']?></option>
    <?php } ?>
    </select>
</div>
...
<div class="form-group">
    ...
    <select name="id_produk" id="id_produk" class="form-control" onchange="updateAvailableStock()">
        ...
        <option value="<?= $value['id_produk']?>" <?= $data_mutation['id_produk'] == $value['id_produk'] ?'selected' : '' ?>><?= $value['nama_produk']?></option>
    <?php } ?>
    </select>
</div>

<div class="form-group">
    <label>Jumlah Stok Produk Yang Tersedia</label>
    <input type="text" id="jumlah_stok"  class="form-control" readonly>
</div>
<div class="form-group">
    <label>Jumlah Stok Mutasi</label>
    <input type="number" name="jumlah_mutation" value="<?= $data_mutation['jumlah_mutation']?>" class="form-control" placeholder="" required>
</div>
<div class="form-group">
    ...
    <option value="">--Pilih Cabang--</option>
    <?php foreach($data_cabang as $key => $value){ ?>
        <option value="<?= $value['id_cabang']?>" <?= $data_mutation['cabang_tujuan'] == $value['id_cabang'] ?'selected' : '' ?>><?= $value['nama_cabang']?></option>
    <?php } ?>
    </select>
</div>
...
<div class="form-group">
    ...
    <input type="date" name="tanggal_mutation" value="<?= $data_mutation['tanggal_mutation']?>" class="form-control" placeholder="Masukkan Tanggal Mutasi" required>
</div>
